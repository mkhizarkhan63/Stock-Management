    ...
    <div class="container" id="invoice">
      <div class="row">
        ...
        <div class="col-md-10 border">
          ...
          <?php 
          $id = $_GET['id'];
      $sql = "SELECT * FROM `debit` INNER JOIN purchase ON purchase.id = debit.purchase_id INNER JOIN accounts ON accounts.id = purchase.acc_id WHERE purchase.id = '$id'  ";
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><strong><?= $row['debit'] ?> Rs</strong></td>
                  </tr>
                </tbody>
              </table>
            </div>
